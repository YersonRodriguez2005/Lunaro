...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 flex-col items-center justify-center overflow-hidden p-12">
        {/* Elementos decorativos */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-full h-full opacity-30"
            style={{
              backgroundImage: 'radial-gradient(circle at 30% 20%, #6366f1 0%, transparent 50%), radial-gradient(circle at 70% 80%, #8b5cf6 0%, transparent 50%)'
            }}
          />
        ...
        <div className="relative z-10 text-center max-w-sm">
          ...
          <div className="space-y-6">
            <blockquote className="text-slate-300 text-xl leading-relaxed italic"
              style={{ fontFamily: "'Playfair Display', serif" }}>
              "La moda es el lenguaje con el que habla tu identidad."
            </blockquote>
          </div>

          {/* Tarjetas decorativas flotantes */}
          <div className="mt-14 relative h-32">
            <div className="absolute left-4 top-0 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 text-left w-48 rotate-[-4deg]">
              <p className="text-white/60 text-xs mb-1">Envío gratuito</p>
              <p className="text-white text-sm font-semibold">En compras +$100k</p>
            </div>
            <div className="absolute right-4 top-6 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 text-left w-44 rotate-3">
              <p className="text-white/60 text-xs mb-1">Nueva colección</p>
              <p className="text-white text-sm font-semibold">Temporada 2026</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3.5 px-6 bg-slate-900 hover:bg-indigo-600 text-white text-sm font-semibold rounded-xl transition-all duration-300 shadow-sm hover:shadow-indigo-500/25 hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
                <>
